...
// Floating Navigation
const floatingNavBtns = document.querySelectorAll('.nav-btn');
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.project-card, .skill-card, .contact-card, .testimonial-card');
...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 20px;
        right: 20px;
        background: ${type === 'success' ? 'linear-gradient(135deg, #34d399, #10b981)' : type === 'error' ? 'linear-gradient(135deg, #ef4444, #dc2626)' : 'linear-gradient(135deg, #60a5fa, #3b82f6)'};
        color: white;
        padding: 1rem 1.5rem;
        border-radius: 12px;
...
// Skills card hover interactions
document.addEventListener('DOMContentLoaded', () => {
